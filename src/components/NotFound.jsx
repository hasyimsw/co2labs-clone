...
export default function NotFound() {
  return (
    <section className="text-secondary flex flex-col items-center justify-center h-screen gap-5">
      <div>
        <img src={logo} alt="brand-logo" className="w-20" />
      </div>
      <h4 className="text-2xl font-bold">Something's missing.</h4>
      <h1 className="font-generalsans font-bold text-9xl">404</h1>
      <h6 className="text-gray-400 mx-5 text-xl">
