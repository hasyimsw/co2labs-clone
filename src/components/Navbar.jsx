...
export default function Navbar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      setIsScrolled(window.scrollY > 0); // scrollY > 0 artinya sudah discroll
    };
  ...
  const ScrollButton = ({ targetid, text }) => {
    ...
    const handleClick = () => {
      if (location.pathname === "/") {
        // Sudah di halaman target, langsung scroll
        const element = document.getElementById(targetid);
        if (element) {
          element.scrollIntoView({ behavior: "smooth" });
        }
      } else {
        // Belum di halaman target, navigate dulu
  ...
  return (
    <nav
      className={`flex lg:flex-row flex-row-reverse items-center justify-between top-0 z-20 lg:px-28 px-10 py-2 fixed w-screen bg-primary ${
    ...
    >
      ...
      <ul className="order-2 lg:flex gap-10 hidden">
        <li className="relative group">
          <button className="font-generalsans font-medium text-xl flex items-center cursor-pointer">
            Our Services
            <i className="ml-1 mt-1 transform transition-transform duration-300 ease-in-out group-hover:rotate-180">
              <svg
            ...
            <ul className="dropMenu p-2">
              <li>
                ...
                >
                  ...
                  <div className="">
                    <h5 className="text-xl font-bold">Website Maintenance</h5>
                    <p className="font-generalsans text-xs font-semibold w-60">
              ...
              <li>
                ...
                >
                  ...
                  <div className="">
                    ...
                    <p className="font-generalsans font-semibold text-xs w-60">
              ...
              <li>
                ...
                >
                  ...
                  <div className="">
                    <h5 className="text-xl font-bold">IT Support</h5>
                    <p className="font-generalsans font-semibold text-xs w-60">
              ...
              <li>
                ...
                >
                  ...
                  <div className="">
                    <h5 className="text-xl font-bold">3rd Party AI Solution</h5>
                    <p className="font-generalsans font-semibold text-xs w-60">
        ...
        <ScrollButton targetid="about" text="About Us" />
        <ScrollButton targetid="portfolio" text="Portfolio" />
        <ScrollButton targetid="contact" text="Contact" />
      </ul>

      {/* get started */}
      <button className="bg-secondary cursor-pointer rounded-md py-2 px-4 font-medium shadow-custom-drop text-primary order-3 lg:block hidden hover:scale-110 transition-all hover:shadow-primary-600 hover:shadow-md">
      ...
      <button
        ...
        className="p-4 order-1 lg:hidden cursor-pointer "
      >
        <svg
          stroke="currentColor"
          fill="currentColor"
      ...
      >
        ...
        <ul className="flex flex-col gap-4 p-4">
          ...
          <li className="list-disc list-inside">
            <Link to="/service/web-main" className="underline">
              Website Maintenance
            </Link>
          </li>
          <li className="list-disc list-inside">
            <Link to="/service/web-dev" className="underline">
              Website & App Development
            </Link>
          </li>
          <li className="list-disc list-inside">
            <Link to="/service/it-support" className="underline">
              IT Support
            </Link>
          </li>
          <li className="list-disc list-inside">
            <Link to="/service/ai-solution" className="underline">
        ...
        <div className="px-4 mt-auto">
          <button className="w-full bg-[#0f2f46] text-white font-semibold py-3 rounded-xl mt-6">
            <Link to="https://api.whatsapp.com/send/?phone=6581181595&text=Hi+Co2%2C+I+would+like+ask+about+your+services.&type=phone_number&app_absent=0">
              Get Started Today!
            </Link>
          </button>
